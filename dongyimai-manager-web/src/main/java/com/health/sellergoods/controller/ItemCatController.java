...
public class ItemCatController {
	...
	public PageResult search(@RequestBody TbItemCat itemCat, Integer page, Integer rows  ){
		return itemCatService.findPage(itemCat, page, rows);
	}


	@RequestMapping("/findByParentId")
	public PageResult findByParentId(Long parentId,Integer page, Integer rows){
